# Bộ dữ liệu mở — Open LLM Business Việt Nam

Thẻ dữ liệu (datasheet) của phần ngữ liệu mở trong dự án **Open LLM Business Việt Nam**.
...
```
BDSG (2026). Bo du lieu mo Open LLM Business Viet Nam.
Phien ban 2026-09-25. Giay phep CC-BY-4.0.
https://github.com/BDSG-VN/open-llm-business-vietnam
```
...
@misc{bdsg_open_llm_business_vietnam_2026,
  title        = {Bo du lieu mo Open LLM Business Viet Nam},
  author       = {{BDSG}},
  year         = {2026},
  version      = {2026-09-25},
  license      = {CC-BY-4.0},
  howpublished = {\url{https://github.com/BDSG-VN/open-llm-business-vietnam}}
}
```

> Đường dẫn kho mã ở trên là **dự kiến theo quyết định của chủ dự án** (repo GitHub công
> khai tên "Open LLM Business Việt Nam"). Kho đã tồn tại công khai tại địa chỉ đó hay chưa:
